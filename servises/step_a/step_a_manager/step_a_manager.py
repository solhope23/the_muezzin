...
from project.classes.dal.readers.file_reader.file_reader import FileReader
...
class StepAManager:
    ...
    def __init__(self):
        ...
        self.topic_name = StepAConfigs.topic
        self.configs_producer = StepAConfigs.get_kafka_configs()
